...
from v2.core import AttentionBank, LPLHeads, make_projector, load_model
from v2.core.bank_patch_dispatch import install_bank_patch_for_model

LPLState = None  # bound at runtime by dispatcher
lpl_state_scope = None  # bound at runtime by dispatcher
...
def main():
    ...
    d = model.config.hidden_size
    global LPLState, lpl_state_scope
    LPLState, lpl_state_scope = install_bank_patch_for_model(model)
