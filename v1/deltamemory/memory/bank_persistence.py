...
def compute_config_sha(
    *,
    ...
    payload = {
        ...
        "num_kv_heads_per_layer": list(num_kv_heads_per_layer) if num_kv_heads_per_layer else None,
        "dtype": str(dtype),
...
def save_bank(
    ...
    *,
    ...
    config_sha = compute_config_sha(
        ...
        num_kv_heads_per_layer=sd.get("num_kv_heads_per_layer"),
        dtype=dtype_str,
    ...
    with FileLock(str(loc.lock_path), timeout=60):
        ...
        meta = {
            ...
            "num_kv_heads_per_layer": list(sd.get("num_kv_heads_per_layer") or []),
            "dtype": dtype_str,
...
def load_bank(
    ...
    *,
    ...
    sd = {
        ...
        "num_kv_heads_per_layer": list(meta.get("num_kv_heads_per_layer") or []),
        "M_K": M_K,
        "M_V": M_V,
