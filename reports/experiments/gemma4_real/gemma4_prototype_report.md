# Mneme Gemma4 Attention-Memory Prototype
...
This is the first practical Gemma4-oriented Mneme prototype path: external attention memory, top-k retrieval, and Q/K/V injection into a frozen decoder LM.
