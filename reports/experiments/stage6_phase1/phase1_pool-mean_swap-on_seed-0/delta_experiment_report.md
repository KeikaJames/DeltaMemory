...
| logit_bias | 19.4968 | 9.5432 | 51615.4583 | 0.5417 | 0.0000 | 0.0000 | 0.0000 | 0.0000 |
| payload_probe | 12.3711 | 3.5603 | 12.3750 | 0.6667 | 0.0000 | 0.0000 | 0.0000 | 0.0000 |
| lm_head_lora | 19.4721 | 4.4937 | 23.8333 | 0.5833 | 0.0000 | 0.0000 | 0.0000 | 0.0000 |
...
- `logit_bias`: mean_delta=`4.7079`, ci95=`[0.8577, 9.0496]`, win_rate=`0.5000`, permutation_p=`0.0220`
...
| logit_bias_oracle_correct | 2.0391 |
| logit_bias_oracle_paired | -2.4010 |
| logit_bias_correct_address_paired_payload | -2.4010 |
| logit_bias_paired_address_correct_payload | 2.0391 |
| payload_probe_oracle_correct | 0.8099 |
| payload_probe_oracle_paired | -0.8099 |
| payload_probe_correct_address_paired_payload | -0.8099 |
| payload_probe_paired_address_correct_payload | 0.8099 |
| lm_head_lora_oracle_correct | 1.4518 |
| lm_head_lora_oracle_paired | -1.9271 |
| lm_head_lora_correct_address_paired_payload | -1.9271 |
| lm_head_lora_paired_address_correct_payload | 1.4518 |
...
| logit_bias_oracle_correct | 2.0391 | 0.3333 | 0.0000 |
| logit_bias_oracle_paired | -2.4010 | 0.0000 | 0.3750 |
| logit_bias_correct_address_paired_payload | -2.4010 | 0.0000 | 0.3750 |
| logit_bias_paired_address_correct_payload | 2.0391 | 0.3333 | 0.0000 |
| payload_probe_oracle_correct | 0.8099 | 0.5000 | 0.0000 |
| payload_probe_oracle_paired | -0.8099 | 0.0000 | 0.5000 |
| payload_probe_correct_address_paired_payload | -0.8099 | 0.0000 | 0.5000 |
| payload_probe_paired_address_correct_payload | 0.8099 | 0.5000 | 0.0000 |
| lm_head_lora_oracle_correct | 1.4518 | 0.0833 | 0.0417 |
| lm_head_lora_oracle_paired | -1.9271 | 0.0000 | 0.1667 |
| lm_head_lora_correct_address_paired_payload | -1.9271 | 0.0000 | 0.1667 |
| lm_head_lora_paired_address_correct_payload | 1.4518 | 0.0833 | 0.0417 |
...
| payload_probe | 3.5603 | 0.5000 | 0.6667 |
| logit_bias | 9.5432 | 0.3333 | 0.5417 |
| lm_head_lora | 4.4937 | 0.0833 | 0.5833 |
