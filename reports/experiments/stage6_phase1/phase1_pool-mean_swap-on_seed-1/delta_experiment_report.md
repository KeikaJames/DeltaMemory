...
| logit_bias | 19.2244 | 7.6153 | 17602.1250 | 0.5833 | 0.0000 | 0.0000 | 0.0000 | 0.0000 |
| payload_probe | 12.7712 | 3.5589 | 13.0000 | 0.7917 | 0.0000 | 0.0000 | 0.0000 | 0.0000 |
| lm_head_lora | 19.1780 | 3.9408 | 16.8333 | 0.6250 | 0.0000 | 0.0000 | 0.0000 | 0.0000 |
...
- `logit_bias`: mean_delta=`3.4125`, ci95=`[0.3445, 7.1366]`, win_rate=`0.4167`, permutation_p=`0.0510`
...
| logit_bias_oracle_correct | 1.8906 |
| logit_bias_oracle_paired | -1.7083 |
| logit_bias_correct_address_paired_payload | -1.7083 |
| logit_bias_paired_address_correct_payload | 1.8906 |
| payload_probe_oracle_correct | 0.6510 |
| payload_probe_oracle_paired | -0.6510 |
| payload_probe_correct_address_paired_payload | -0.6510 |
| payload_probe_paired_address_correct_payload | 0.6510 |
| lm_head_lora_oracle_correct | 1.2526 |
| lm_head_lora_oracle_paired | -1.3008 |
| lm_head_lora_correct_address_paired_payload | -1.3008 |
| lm_head_lora_paired_address_correct_payload | 1.2526 |
...
| logit_bias_oracle_correct | 1.8906 | 0.2083 | 0.0417 |
| logit_bias_oracle_paired | -1.7083 | 0.0833 | 0.1667 |
| logit_bias_correct_address_paired_payload | -1.7083 | 0.0833 | 0.1667 |
| logit_bias_paired_address_correct_payload | 1.8906 | 0.2083 | 0.0417 |
| payload_probe_oracle_correct | 0.6510 | 0.1667 | 0.0417 |
| payload_probe_oracle_paired | -0.6510 | 0.0417 | 0.1667 |
| payload_probe_correct_address_paired_payload | -0.6510 | 0.0417 | 0.1667 |
| payload_probe_paired_address_correct_payload | 0.6510 | 0.1667 | 0.0417 |
| lm_head_lora_oracle_correct | 1.2526 | 0.1250 | 0.0833 |
| lm_head_lora_oracle_paired | -1.3008 | 0.0833 | 0.1667 |
| lm_head_lora_correct_address_paired_payload | -1.3008 | 0.0833 | 0.1667 |
| lm_head_lora_paired_address_correct_payload | 1.2526 | 0.1250 | 0.0833 |
...
| payload_probe | 3.5589 | 0.1667 | 0.7917 |
| logit_bias | 7.6153 | 0.2083 | 0.5833 |
| lm_head_lora | 3.9408 | 0.1667 | 0.6250 |
