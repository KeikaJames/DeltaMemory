...
- `eval_injection_modes`: `lm_head_lora,payload_probe,logit_bias,oracle_logit_answer_embedding`
...
| payload_probe | 12.3062 | 12.4178 | 98773.2500 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 |
| lm_head_lora | 21.3275 | 35.6559 | 54585.6875 | 0.0625 | 0.0000 | 0.0000 | 0.0000 | 0.0000 |
...
| payload_probe_oracle_correct | -0.0091 |
| payload_probe_oracle_paired | 0.0091 |
| payload_probe_correct_address_paired_payload | 0.0091 |
| payload_probe_paired_address_correct_payload | -0.0091 |
| lm_head_lora_oracle_correct | -2.4326 |
| lm_head_lora_oracle_paired | 0.5410 |
| lm_head_lora_correct_address_paired_payload | 0.5410 |
| lm_head_lora_paired_address_correct_payload | -2.4326 |
...
| payload_probe_oracle_correct | -0.0091 | 0.0000 | 0.0000 |
| payload_probe_oracle_paired | 0.0091 | 0.0000 | 0.0000 |
| payload_probe_correct_address_paired_payload | 0.0091 | 0.0000 | 0.0000 |
| payload_probe_paired_address_correct_payload | -0.0091 | 0.0000 | 0.0000 |
| lm_head_lora_oracle_correct | -2.4326 | 0.0000 | 0.0000 |
| lm_head_lora_oracle_paired | 0.5410 | 0.0000 | 0.0000 |
| lm_head_lora_correct_address_paired_payload | 0.5410 | 0.0000 | 0.0000 |
| lm_head_lora_paired_address_correct_payload | -2.4326 | 0.0000 | 0.0000 |
...
| lm_head_lora | 35.6559 | 0.0000 | 0.0625 |
| payload_probe | 12.4178 | 0.0000 | 0.0000 |
