...
- `eval_injection_modes`: `logit_bias,payload_probe,oracle_logit_answer_embedding`
...
| logit_bias | 19.1040 | 21.9531 | 87996.3750 | 0.3750 | 0.0000 | 0.0000 | 0.0000 | 0.0000 |
| payload_probe | 12.3062 | 12.3630 | 92884.8750 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 |
...
| logit_bias_oracle_correct | 3.9131 |
| logit_bias_oracle_paired | -4.3496 |
| logit_bias_correct_address_paired_payload | -4.3496 |
| logit_bias_paired_address_correct_payload | 3.9131 |
| payload_probe_oracle_correct | -0.0661 |
| payload_probe_oracle_paired | 0.0661 |
| payload_probe_correct_address_paired_payload | 0.0661 |
| payload_probe_paired_address_correct_payload | -0.0661 |
...
| logit_bias_oracle_correct | 3.9131 | 0.2500 | 0.0000 |
| logit_bias_oracle_paired | -4.3496 | 0.0000 | 0.2500 |
| logit_bias_correct_address_paired_payload | -4.3496 | 0.0000 | 0.2500 |
| logit_bias_paired_address_correct_payload | 3.9131 | 0.2500 | 0.0000 |
| payload_probe_oracle_correct | -0.0661 | 0.0000 | 0.0000 |
| payload_probe_oracle_paired | 0.0661 | 0.0000 | 0.0000 |
| payload_probe_correct_address_paired_payload | 0.0661 | 0.0000 | 0.0000 |
| payload_probe_paired_address_correct_payload | -0.0661 | 0.0000 | 0.0000 |
...
| logit_bias | 21.9531 | 0.2500 | 0.3750 |
| payload_probe | 12.3630 | 0.0000 | 0.0000 |
